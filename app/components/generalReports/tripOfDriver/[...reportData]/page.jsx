    ...
    <div>
      ...
      <div className="w-full flex gap-5 flex-col p-4 justify-center items-center ">
        <div className = "flex flex-col w-3/5 gap-3 justify-center items-center">
            ...
            <div className=" font-extrabold text-lg bg-teal-600 p-3 rounded-md">{data[0].DriverName}</div>
            <div className="w-3/4 flex flex-row gap-3"> <div className="w-1/6 font-bold">License No</div><div>{data[0].DriverLicenceNo}</div></div>
