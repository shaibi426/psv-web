...
const Pdfpicker = (props) => {
  return (
    ...
    <div className={`w-full rounded-md  p-1 m-1 flex flex-col text-sm font-sans items-center gap-2 font-semibold justify-between`}>
        ...
        <input maxLength={500} spellCheck= {true} type = 'file'  accept='.pdf' className='p-2 bg-white   w-11/12 font-normal focus:outline-0 border rounded-md ml-2 border-slate-400 focus:border-blue-400 mr-3 focus:border focus:rounded-md '  />
    </div>
